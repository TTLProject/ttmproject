...
public class exeditdao {
	public void edit(employee emp) {
		try {
			...
			PreparedStatement pst=con.prepareStatement("update extckt set description=?,project=?,module=?,requirement=?,Dateissue=?,Datecmplt=?,status=?,Assignedto=? where ticketid=?");
