...
PreparedStatement pst=con.prepareStatement("select * from extckt");
...
%>
                                        ...
                                        <tr bgcolor="">
											...
											<a href="executiveEditTicket.jsp?ticket=<%=rs.getString(1)%>"><button  class="btn btn-info">Edit</button></a></td>
                                        </tr>
